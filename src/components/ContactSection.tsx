...
import { useToast } from '@/hooks/use-toast'; // Ajuste o path se necessário
import {
    Clock,
    MapPin,
    MessageCircle,
...
import Footer from './Footer'; // IMPORTANTE: O caminho deve corresponder ao seu Footer.tsx
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-8 order-2 lg:order-1">
                        <div className="grid gap-4">
                            <Card className="border-border/40 bg-card shadow-sm hover:border-primary/30 transition-colors">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {socialLinks.map((social, index) => (
                                    <Button
                                        ...
                                        variant="outline"
                                        size="icon"
                                        className="h-12 w-12 rounded-xl bg-card hover:bg-primary/10 hover:scale-110 transition-all border-border hover:border-primary/20 group shadow-sm"
                                    ...
                                    >
                                        <img
                                            src={social.iconSrc}
                                            alt=""
                                            // brightness-0 deixa os SVGs escuros (preto/cinza escuro) caso antes fossem brancos.
                                            className="h-6 w-6 object-contain opacity-70 group-hover:opacity-100 transition-opacity brightness-0"
                                            aria-hidden="true"
                                        />
                                    </Button>
                                ))}
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input placeholder="Seu nome" {...field} className="bg-background border-border shadow-sm focus-visible:ring-primary" />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input placeholder="seu@email.com" {...field} className="bg-background border-border shadow-sm focus-visible:ring-primary" />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input placeholder="Sobre o que vamos falar?" {...field} className="bg-background border-border shadow-sm focus-visible:ring-primary" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                                    ...
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Textarea
                                                                ...
                                                                className="min-h-[150px] resize-none bg-background border-border shadow-sm focus-visible:ring-primary"
                                                                {...field}
                                                            />
                                                        </FormControl>
                                                        <FormMessage />
